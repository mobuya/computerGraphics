class Shape {
    ...
    drawLocalCoordinateSystem() {
        ...
        gl.bindBuffer(gl.ARRAY_BUFFER, axisVertexBuffer);
        gl.vertexAttribPointer(
            locations.attributes.vertexLocation,
            3,
            gl.FLOAT,
            gl.FALSE,
            0,
        ...
        gl.enableVertexAttribArray(locations.attributes.vertexLocation);

        gl.bindBuffer(gl.ARRAY_BUFFER, axisColorBuffer);
        gl.vertexAttribPointer(
            locations.attributes.colorLocation,
            3,
            gl.FLOAT,
            gl.FALSE,
            0,
        ...
        gl.enableVertexAttribArray(locations.attributes.colorLocation);
